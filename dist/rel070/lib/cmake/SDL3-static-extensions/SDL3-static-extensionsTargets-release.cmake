...
# Import target "SDL3-static-extensions::SDKShared" for configuration "Release"
set_property(TARGET SDL3-static-extensions::SDKShared APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(SDL3-static-extensions::SDKShared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSDL3_static_extensions.0.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libSDL3_static_extensions.0.dylib"
  )

list(APPEND _cmake_import_check_targets SDL3-static-extensions::SDKShared )
list(APPEND _cmake_import_check_files_for_SDL3-static-extensions::SDKShared "${_IMPORT_PREFIX}/lib/libSDL3_static_extensions.0.7.0.dylib" )

# Import target "SDL3-static-extensions::SDKCxxShared" for configuration "Release"
set_property(TARGET SDL3-static-extensions::SDKCxxShared APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(SDL3-static-extensions::SDKCxxShared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSDL3_static_extensions_cxx.0.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libSDL3_static_extensions_cxx.0.dylib"
  )

list(APPEND _cmake_import_check_targets SDL3-static-extensions::SDKCxxShared )
list(APPEND _cmake_import_check_files_for_SDL3-static-extensions::SDKCxxShared "${_IMPORT_PREFIX}/lib/libSDL3_static_extensions_cxx.0.7.0.dylib" )
